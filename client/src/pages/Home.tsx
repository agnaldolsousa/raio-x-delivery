    ...
    <div className="min-h-screen bg-[#05070a] text-slate-100 selection:bg-cyan-500/30">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-red-500/20 overflow-hidden">
                <img src="/assets/print_despesas.png" alt="Controle de Despesas" className="w-full h-auto grayscale hover:grayscale-0 transition duration-500" />
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 relative">
              ...
              <img src="/assets/print_faturamento.png" alt="Faturamento Mensal" className="relative rounded-2xl border border-white/10 shadow-2xl" />
            </div>
            ...
            <div className="bg-gradient-to-br from-cyan-600 to-blue-700 p-8 rounded-3xl text-white space-y-6 relative overflow-hidden group">
              ...
              <ul className="space-y-4 relative z-10">
                <li className="flex items-center gap-3">
                  ...
                  <span>Ebook explicativo de gestão financeira</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="bg-white/20 p-1 rounded-full"><CheckCircle2 className="w-4 h-4" /></div>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-2xl mx-auto bg-[#0f172a] border border-cyan-500/30 rounded-[40px] p-12 text-center shadow-[0_0_50px_rgba(0,210,255,0.1)]">
            ...
            <Button
              onClick={handleCTA}
              className="w-full bg-cyan-600 hover:bg-cyan-500 text-white text-2xl font-black py-10 rounded-3xl glow-blue transition-all transform hover:scale-105"
            >
            ...
            <div className="mt-10 p-6 bg-gradient-to-r from-cyan-600/20 to-blue-600/20 border-2 border-cyan-500 rounded-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-3">
                ...
                <p className="text-white font-bold text-lg leading-relaxed">
                  Você também recebe <span className="text-cyan-300">1 hora de consultoria individual comigo</span>, com horário agendado, para configurar sua planilha e ajustar seu delivery na prática.
                </p>
      ...
      <footer className="py-12 border-t border-white/5 bg-[#05070a]">
        <div className="container flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-3">
            <img src="/assets/logo.png" alt="Raio-X Logo" className="h-8 opacity-50" />
